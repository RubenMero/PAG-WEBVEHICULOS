document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadLastIngresos() {
        ...
        if (sortedIngresos.length === 0) {
            tableBody.innerHTML = '<tr><td colspan="5">Aún no hay registros de ingreso.</td></tr>';
            return;
        }
    ...
    ingresoForm.addEventListener('submit', (e) => {
        ...
        const newEntry = {
            ...
            estado: 'ACTIVO', // Activo, esperando registro de salida
            fechaSalida: null,
            horaSalida: null,
        ...
        window.showNotification(`Ingreso de ${placa} registrado con éxito.`, 'success');
        ingresoForm.reset();
        loadLastIngresos();
    });
